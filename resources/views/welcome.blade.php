...
<body>
  ...
  <div> pick language (hr/en/fr) <a href="http://127.0.0.1:8000/api/meals?lang=hr"> http://127.0.0.1:8000/api/meals?lang=hr</a> </br>
    ...
    add more info (category, tags, ingredients) can be one or all three, up to you<a href="http://127.0.0.1:8000/api/meals?lang=hr&with=category,tags,ingredients"> http://127.0.0.1:8000/api/meals?lang=hr&with=category,tags,ingredients</a> </br>
